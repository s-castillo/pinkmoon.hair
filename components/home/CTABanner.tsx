...
export function CTABanner({ headline, supportingText, ctaLabel, ctaHref }: CTABannerProps) {
  return (
    <section className="mx-auto w-full max-w-[820px] px-6 pb-20 md:pb-[100px]">
      <div className="rounded-2xl border border-brand/40 bg-brand/10 p-8 text-center md:p-10">
        <h2
        ...
        <p className="mx-auto mt-3 max-w-xl text-[15px] leading-relaxed text-white/55">{supportingText}</p>
